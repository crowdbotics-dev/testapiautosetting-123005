...
## Project Structure
    ...
    ├── testapiautosetting_123005  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_123005`
...
2. Clone this repo and `cd testapiautosetting_123005`
